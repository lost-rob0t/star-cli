...
when isMainModule:
  const targetHelp = {"target": "target value or path to file when in bulk mode", "dataset": "Dataset for actors to store data in (actor is a bot)",
                      ...
                      "recurring": "Is this a repeatable target?",
                      "delay": "Minmium time bwteen sending this target to actors.",
  ...
  # FIXME Broken, also Move this to starRouter subcommand ./star router subscribe
